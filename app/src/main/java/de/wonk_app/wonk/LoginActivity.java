...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        facebookLoginButton = (LoginButton) findViewById(R.id.btn_fblogin);

        mLoginFormView = findViewById(R.id.login_form);
        mProgressView = findViewById(R.id.login_progress);
    }

    private void registerCallbackOnFBLogin() {
        ...
        facebookLoginButton.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onSuccess(LoginResult loginResult) {
                ...
                Intent menueActivity = new Intent(getApplicationContext(), MenueActivity.class);
                startActivity(menueActivity);
                finish();
            }
    ...
    private boolean isEmailValid(String email) {
        //TODO: Fill in E-Mail in database table User
        return email.contains("@");
    }

    private boolean isPasswordValid(String password) {
        //TODO: Fill in password in database table User
